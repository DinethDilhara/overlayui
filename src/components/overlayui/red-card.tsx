...
export interface RedCardOverlayProps {
...
export default function RedCardOverlay({
  teamLogo,
  playerNumber,
  playerName,
  tournamentLogo,
        ...
        >
          ...
          <div className="relative flex h-[5vw] max-h-30 min-h-22 w-full overflow-hidden rounded-xl">
            ...
            <div className="absolute inset-[0.6vw] z-10 flex items-center justify-between rounded-xl bg-black px-[0.8vw]">
              ...
              {/* Red Card */}
              <div className="rder-red-500 flex h-[2.5vw] min-h-8 w-[1.5vw] min-w-8 items-center justify-center bg-[#DC2626] shadow-md"></div>
            </div>
          </div>
