...
import OverlayShowcase from "@/components/layout/overlay-showcase"
    ...
    <>
      ...
      <main>
        ...
        {/* <section
          ...
          className="w-full border-b border-gray-300 dark:border-neutral-800"
        >
        ...
        {sections.map((section, index) => (
          <section
            ...
            className="flex h-screen w-screen items-center justify-center border-b border-gray-300 dark:border-neutral-800"
          >
            {section.component ?? (
